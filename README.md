...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-e7zam8y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-e7zam8y.containers.anotherwebservice.com/
...
```
git clone git@github.com:KnightCoder248/container-e7zam8y.git
cd container-e7zam8y
```
...
```
docker attach container-e7zam8y
```
